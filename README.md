...
`ORB-D01` (shell), `ORB-D04` (pipelines), `ORB-D05` (kanban) y `ORB-D02` (contactos) van apilados. Inicio sigue con KPIs vacíos. El historial de conversación en la ficha espera a Track B. El sitio público todavía no.
